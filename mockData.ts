...
export const MOCK_USUARIOS: Usuario[] = [
  {
    ...
    datosAnfitrion: { cantPartidasActuales: 1, karma: 98 } // Tomi es AMBAS cosas
  },
  {
    idUsuario: 2,
    ...
    datosJugador: { estado: true } // Sofi es solo jugadora
  },
  {
    idUsuario: 3,
    ...
    nickname: "CarlosDM",
    datosAnfitrion: { cantPartidasActuales: 1, karma: 85 } // Carlos es solo anfitrión
  }
];
